...
namespace Resort_Application.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IBookingService bookingService, IWebHostEnvironment webHostEnvironment,
                                  IVillaService villaService, IVillaNumberService villaNumberServic,
                                  UserManager<ApplicationUser> userManager)
        {
            _bookingService = bookingService;
            _webHostEnvironment = webHostEnvironment;
            _villaService = villaService;
            _villaNumberService = villaNumberServic;
        ...
        public IActionResult FinalizeBooking(Booking booking)
        {
            ...
            if (!_villaService.IsVillaAvailable(villa.Id,booking.Nights,booking.CheckInDate))
            {
        ...
        public IActionResult GenerateInvoice(int id, string downloadType)
        {
            ...
            //Update the template
             ...
             Booking bookingFormDb = _bookingService.GetBookingById(id);
